...
cutscenes = [
	[	// X Chara with Sans's soul (Index: 0)
		...
		[cutscene_object_set_sprite, cross, spr_cross_xevent_down_looking_left],
		[cutscene_wait_by_dialog, 5],
		[cutscene_object_set_sprite, cross, spr_cross_xevent_down_looking_left_crossed_arms],
		...
		[cutscene_execute, function () {
			...
			instance_destroy(xchara);
			layer_background_sprite(layer_background_get_id(layer_get_id("Background")), spr_background_black);
		...
		// Cross and Nightmare
		[cutscene_execute, function () {
			layer_background_sprite(layer_background_get_id(layer_get_id("Background")), spr_background_empty_xtale_evening);
			audio_play_soundtrack(snd_dark_dream);
			effect_shake(2, 0);
		...
		[cutscene_wait_by_dialog, 1],
		[cutscene_object_set_sprite, nightmare, spr_nightmare_down_looking_right_tentacles],
		[cutscene_wait_dialog_end],
		[cutscene_wait, 1],
		[cutscene_dialog_async, episode + "Dialog13"],
		[cutscene_wait_by_dialog, 2],
		[cutscene_object_set_sprite, nightmare, spr_nightmare_down_looking_up_tentacles],
		[cutscene_wait_dialog_end],
		[cutscene_wait, 1],
		[cutscene_object_set_sprite, cross, spr_cross_xevent_down_looking_right_crossed_arms],
		[cutscene_wait, 2],
		[cutscene_object_set_sprite, cross, spr_cross_xevent_down_looking_left_crossed_arms],
		...
		[cutscene_object_set_sprite, dream, spr_dream_left_walking_greets_finish],
		[cutscene_wait, 1],
		[cutscene_object_set_sprite, dream, spr_dream_left_hand_down_afraid],
		[cutscene_wait, 1],
		[cutscene_object_set_sprite, dream, spr_dream_left_worried],
		[cutscene_wait, 0.5],
		[cutscene_dialog, episode + "Dialog16"],
		[cutscene_wait, 1],
		[cutscene_object_set_sprite, dream, spr_dream_left_worried_teleporting],
