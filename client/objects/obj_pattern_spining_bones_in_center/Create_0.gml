...
callback = function () {
	...
	bone_instance_1 = create_bone_spinning(border_instance.x, border_instance.y, rotating_bone, bone_speed, 0, 0, 0, angle_speed);
	bone_instance_2 = create_bone_spinning(border_instance.x, border_instance.y, rotating_bone, bone_speed, 0, 0, 90, angle_speed);
