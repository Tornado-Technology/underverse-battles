...
update = function () {
	...
	bone_instances[index] = instance_create_depth(bone_x, bone_y, fight_depth.bullet_outside, bone);

	bone_instances[index].image_angle = random_side + 90;
	bone_instances[index].direction = random_side + 180;
	bone_instances[index].set_fall(2, 0.04 + _power * 0.02);
	index++;
}
