...
if (ctime >= ctime_max) {
	...
	var new_x = 500;
	var new_y = irandom_range(60, 280);
	var _inst = instance_create_depth(new_x, new_y, 0, choose_weighted(obj_banana_minigame_car, 15, obj_banana_minigame_car_mini, 10, obj_banana_minigame_car_dog, 1));
