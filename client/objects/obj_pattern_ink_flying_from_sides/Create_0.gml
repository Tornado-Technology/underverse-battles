...
update = function() {
		...
		create_drop(x0, y0, drops[drop_index], fight_random_float(0.5 + _power * 0.15, 2 + _power * 0.1), inst_dir, true);
	}
...
time_source_update_destroy = time_source_create(time_source_game, 6.5 + _power * 0.75, time_source_units_seconds, function() {
	instance_destroy();
});