...
hand_left_up_animation = spr_cross_attack2_left_up;
hand_right_up_animation = spr_cross_attack2_right_up;
hand_down_animation = spr_cross_attack2_down;
hand_up_down_animation = spr_cross_attack2_up_down;
hand_left_down_animation = spr_cross_attack2_left_down;
hand_right_down_animation = spr_cross_attack2_right_down;
hand_left_animation = spr_cross_attack2_left;
hand_up_left_animation = spr_cross_attack2_up_left;
hand_down_left_animation = spr_cross_attack2_down_left;
hand_right_left_animation = spr_cross_attack2_right_left;
hand_right_animation = spr_cross_attack2_right;
hand_up_right_animation = spr_cross_attack2_up_right;
hand_down_right_animation = spr_cross_attack2_down_right;
hand_left_right_animation = spr_cross_attack2_left_right;
