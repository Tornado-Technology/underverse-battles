...
time_source_update_platforms = time_source_create(time_source_game, (platform_distance / 60) / main_speed, time_source_units_seconds, function () {
	update_platforms();
}, [], -1);