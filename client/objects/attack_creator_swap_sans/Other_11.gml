...
switch (attack_num) {
	...
	case 1:	// Вращающиеся кости крестом по центру
		...
		time_source_border_delay = time_source_create(time_source_game, time_border_delay, time_source_units_seconds, function () {
			...
			_inst1 = create_spinning_bone(_border.x, _border.y, bone_spin_obj, bone_speed, 0, 0, 0, angle_speed);
			_inst2 = create_spinning_bone(_border.x, _border.y, bone_spin_obj, bone_speed, 0, 0, 90, angle_speed);
