...
callback = function () {
	...
	var tentacles_instance_1 = instance_create_depth(border_right - 21 *  i, border_down, fight_depth.bullet_outside_hight, tentacles, {
	 ...
	 tentacles_instance_0.back_time = 0.1 + _power * 0.1;
	 tentacles_instance_0.change_scale(1, 1.3, 0.3, end_start);
	 
	 end_start = 0.07;
	 end_start -= random_range(0.01, 0.05);
	 tentacles_instance_1.back_time = 0.1 + _power * 0.1;
	 tentacles_instance_1.change_scale(1, 1.3, 0.3, end_start);
