...
update_gasterblasters = function() {
	repeat (_power == 5 ? 2 : 1) {
		...
		switch (_gb_pos) {
			case 0:
				create_gasterblaster(gasterblaster, border_instance.x + 20, border_instance.y - border_instance.up - border_dist, border_instance.x + 20, border_instance.y, 0);
				break;
			case 1:
				create_gasterblaster(gasterblaster, border_instance.x, border_instance.y - border_instance.up - border_dist, border_instance.x, border_instance.y, 0);
				break;
			case 2:
				create_gasterblaster(gasterblaster, border_instance.x - 20, border_instance.y - border_instance.up - border_dist, border_instance.x - 20, border_instance.y, 0);
				break;
