...
update_scythe = function () {
	...
	speed_count: 3 + _power * 0.1	
			...
			jevil_instance.position_x = border_instance.x + border_instance.right + 30;
				...
				jevil_instance = instance_create_depth(border_instance.x + border_instance.right +	30, border_instance.y + border_instance.down - 20, -8888, obj_turning_scythe_jevil, {
				speed_count: 3 + _power * 0.1	
		});
