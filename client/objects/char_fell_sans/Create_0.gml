...
// Actions
passive_skill_name = translate_get("Character.FellSans.PassiveSkill.Name");
passive_skill_desc = translate_get("Character.FellSans.PassiveSkill.Description");
actions = [
	Action("Bones",fight_action_type.attack, fell_sans_attack0),
	Action("Gasterblasters", fight_action_type.attack, fell_sans_attack1),
	Action("BlueAttack", fight_action_type.attack, fell_sans_attack2)
];
