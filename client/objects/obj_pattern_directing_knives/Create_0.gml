...
update = function() {
	...
	instance_create_depth(rX, rY, 0, knife, {
		...
		_speed: 3.5 + _power * 0.1,
	});
}

time_source_update = time_source_create(time_source_game, (16 - _power * 2) / 60, time_source_units_seconds, function() {
	update();
}, [], -1);
time_source_update_destroy = time_source_create(time_source_game, (300 + _power * 30) / 60, time_source_units_seconds, function() {
	instance_destroy();
});