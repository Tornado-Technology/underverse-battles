...
if (_id == 2 && attack_num == 0) {
	update_2_0 = function() {
		var random_position = new Vector2(irandom_range(_border.x - _border.left + 2, _border.x + _border.right - 2), irandom_range(_border.y - _border.up + 2, _border.y + _border.down - 2));
...
if (_id == 2 && attack_num == 1) {
	update_2_1 = function() {
		var random_position = new Vector2(irandom_range(_border.x - _border.left + 2, _border.x + _border.right - 2), _border.y);
		instance_create_depth(random_position.x, random_position.y, fight_depth.bullet_outside, obj_damage_zone_warning_xchara);
	}
}