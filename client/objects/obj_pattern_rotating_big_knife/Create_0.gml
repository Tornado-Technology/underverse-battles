...
callback = function () {
	...
	knife_instance = create_big_knife_x(border_instance.x - border_instance.left - 30, border_instance.y, big_knife, 0, 0, border_instance.x + border_instance.right + 20, fight_network_mode);
...
update = function() {
	set_big_knife_spin(big_knife, choose(-1, 1) * (3 + _power * 0.2), fight_network_mode);
	set_big_knife_move(big_knife, 3 + _power * 0.2, fight_network_mode);
}
