...
idle_animation = spr_x_anastasia_idle;
after_battle_animation = spr_x_anastasia_idle;
defeated_animation =  spr_x_anastasia_defeated;
fight_0_start_animation = spr_x_anastasia_idle;
fight_0_idle_animation = spr_x_anastasia_idle;
fight_0_finish_animation = spr_x_anastasia_idle;
fight_1_start_animation = spr_x_anastasia_swords_start;
fight_1_idle_animation = spr_x_anastasia_swords_idle;
fight_1_finish_animation = spr_x_anastasia_swords_finish;
fight_2_start_animation = spr_x_anastasia_scythe_start;
fight_2_idle_animation = spr_x_anastasia_scythe_idle;
fight_2_finish_animation = spr_x_anastasia_scythe_finish;

// Actions
passive_skill = PassiveSkill("Character.XAnastasia.PassiveSkill");
actions = [

	Action("Character.Dream.Attack0", call_attack_x_anastasia_0),
	Action("Character.Dream.Attack1", call_attack_x_anastasia_1),
