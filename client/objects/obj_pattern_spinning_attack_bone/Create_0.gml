...
update = function() {
	...
	var x_ = choose(border_instance.x - border_instance.left - irandom_range(10, 30),  border_instance.x + border_instance.right + irandom_range(10, 30));
	var bone_instance_0;
	
	
	bone_instance_0 = instance_create_depth(x_, cood, fight_depth.bullet_outside_hight, bone);
