...
update = function() {
	...
	if (side == 1 || side == 2) {
		...
		create_changing_bone(border_instance.x + border_instance.right, border_instance.y - border_instance.up - 20, bone_changing, bone_speed, bone_up_size, 180, 180, bone_up_size - 3, 30, 20, true, true);
	}
}
