...
update = function () {
	...
	if (soul_instance.is_stunned) {
		var drop_index = fight_random_integer(0, array_length(drops_2_phase) - 1);
		create_drop(x0, border_instance.y - border_instance.up - 5, drops_2_phase[drop_index], 1.5 + _power * 0.1, 270, false);
		return;
	}
