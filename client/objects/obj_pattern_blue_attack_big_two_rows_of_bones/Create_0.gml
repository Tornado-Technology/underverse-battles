// Arguments: bone, custom_repeats (optional), gasterblaster
...
time_source_update_destroy = time_source_create(time_source_game, (period_gasterblaster * repeats) / (60 + (1 + _power * 0.1)), time_source_units_seconds, function () {
	instance_destroy();
});