...
switch(type) {
	case 0:
		create_border(battle_border.up - 30 - _power * 2, battle_border.down - 30 - _power * 2, battle_border.left - 50, battle_border.right - 50);
	...
	default:
		...
		pattern_instance = create_pattern(obj_pattern_feathers_and_wings, {
