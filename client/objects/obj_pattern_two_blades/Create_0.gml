...
var	coord = rand_side_from(border_instance.x - border_instance.left - 8, border_instance.y - border_instance.up - 8, border_instance.x + border_instance.right + 8, border_instance.y + border_instance.down + 8);
