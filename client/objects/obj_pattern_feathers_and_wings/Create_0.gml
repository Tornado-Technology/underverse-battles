...
update = function() {
	var	coord = rand_side_from(border_instance.x - border_instance.left - 50, border_instance.y - border_instance.up - 50, border_instance.x + border_instance.right + 50, border_instance.y + border_instance.down + 50);
