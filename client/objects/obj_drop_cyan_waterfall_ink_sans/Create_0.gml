...
part_type_color1(part_type_ui_ink, c_aqua);
...
spwan_ink = function () {
	...
	var ink_instance = instance_create_depth(position_x, position_y, fight_depth.bullet_outside_hight, obj_drop_cyan_ink_sans, {
