callback = function () {
	...
	instance_create_depth(border_instance.x, border_instance.y, fight_depth.bullet_outside_hight, obj_scythe_xanastasia, {
...
update = function () {
	...
	if(fight_random_integer(0, 1)) {
		position_x = choose(border_instance.x - border_instance.left - 80, border_instance.x + border_instance.right + 80);	
		...
		position_y = choose(border_instance.y - border_instance.up - 80, border_instance.y + border_instance.down + 80);	
