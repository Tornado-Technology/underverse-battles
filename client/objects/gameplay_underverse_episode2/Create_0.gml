...
cutscenes = [
	[	
		...
		[cutscene_wait, 3],
		[cutscene_object_set_sprite, ink_sans, spr_ink_sans_sitting2],
		[cutscene_wait, 1],
		[cutscene_object_set_sprite, ink_sans, spr_ink_sans_sitting1],
		[cutscene_dialog_async, episode + "Dialog2"],
		[cutscene_wait_by_dialog, 1],
		[cutscene_object_set_sprite, sans, spr_sans_sitting1],
		[cutscene_wait_by_dialog, 3],
		[cutscene_object_set_sprite, sans, spr_sans_sitting2],
		[cutscene_wait_dialog_end],
		[cutscene_object_set_sprite, ink_sans, spr_ink_sans_sitting3],
		[cutscene_object_set_sprite, sans, spr_sans_sitting3],
		[cutscene_choise, episode + "Choise1", function (index) {
			if (index == 1) {
				ink_has_gone = true;
			}
			cutscene_create(cutscenes[index + 1]);
		}]
	],
	[
		...
		[cutscene_object_set_sprite, ink_sans, spr_ink_sans_pukes],
		[cutscene_object_set_sprite, sans, spr_sans_sitting5],
		[audio_play_sound_once, snd_ink_puking],
		[cutscene_wait, 3],
		[cutscene_object_set_sprite, ink_sans, spr_ink_sans_sitting_joyful],
		[cutscene_object_set_sprite, sans, spr_sans_sitting6],
		[cutscene_dialog_async, episode + "Dialog4_Line1"],
		[cutscene_wait_by_dialog, 1],
		[cutscene_object_set_sprite, ink_sans, spr_ink_sans_apologetic],
		[cutscene_wait_dialog_end],
		[effect_fade, 3, 1, 1, c_white],
		...
		[cutscene_wait_by_dialog, 1],
		[cutscene_object_set_sprite, ink_sans, spr_ink_sans_flying_distracting],
		[cutscene_wait_by_dialog, 3],
		[cutscene_object_set_sprite, ink_sans, spr_ink_sans_flying_throwing_stuff],
		[cutscene_wait, 2],
		[cutscene_execute, function () {
		...
		[cutscene_wait_dialog_end],
		[effect_fade, 1, 0.5, 1, c_black, false],
		[cutscene_wait, 1.5],
		...
		[cutscene_object_set_sprite, cross, spr_cross_sitting_crying_turns_around],
		[cutscene_object_set_sprite, ink_sans, spr_ink_sans_walking_right_calm],
		[cutscene_character_move, ink_sans, 70, 0, 0.3],
		[cutscene_wait_by_dialog, 5],
		[cutscene_object_set_sprite, cross, spr_cross_sitting_crying_turns_back],
		[cutscene_character_skip_moving, ink_sans],
		[cutscene_object_set_sprite, ink_sans, spr_ink_sans_sits_down],
		[cutscene_wait_dialog_end],
		...
		[cutscene_object_set_sprite, ink_sans, spr_ink_sans_sitting_looking_down],
		[cutscene_object_shift_position, cross, -140, 0],
		[cutscene_object_set_sprite, cross, spr_cross_sitting_wipes_away_tears],
		...
		[cutscene_wait, 1],
		[cutscene_object_set_sprite, ink_sans, spr_ink_sans_sitting_looking_right],
		[cutscene_wait_dialog_end],
		[effect_fade, 0.9, 0.1, 1, c_black],
		[cutscene_wait, 1],
		...
		[cutscene_wait, 5],
		[cutscene_object_set_sprite, ink_sans, spr_ink_sans_running_right_without_broomie],
		[cutscene_object_set_sprite, cross, spr_cross_running_right_with_broomie],
		...
		[cutscene_wait, 2],
		[cutscene_object_set_sprite, ink_sans, spr_ink_sans_sitting_right1],
		[cutscene_object_set_sprite, cross, spr_cross_left_calm],
		[cutscene_wait_by_dialog, 1],
		[cutscene_object_set_sprite, ink_sans, spr_ink_sans_sitting_right1],
		[cutscene_object_set_sprite, cross, spr_cross_left_calm],
		[cutscene_wait_dialog_end],
		[effect_fade, 1.5, 0.5, 1.5, c_white],
		[cutscene_wait, 2],
		// Core Frisk
		...
		[cutscene_wait_by_dialog, 2],
		[cutscene_object_set_sprite, ink_sans, spr_ink_sans_sitting7],
		[cutscene_wait_by_dialog, 3],
		[cutscene_object_set_sprite, ink_sans, spr_ink_sans_sitting8],
		[cutscene_wait_dialog_end],
		[cutscene_wait, 1],
		[cutscene_object_set_sprite, sans, spr_sans_sitting8],
		[cutscene_wait, 1],
	...
	[
		...
		[cutscene_wait_dialog_end],
		[cutscene_wait, 2.5],
		[cutscene_object_set_sprite, ink_sans, spr_ink_sans_right_empty_eyes],
		[cutscene_dialog, episode + "Dialog4_Line2"],
		[cutscene_object_set_sprite, ink_sans, spr_ink_sans_right_empty_eyes_walking],
		...
		[cutscene_execute_by_dialog, 1, function () { 
			sans.sprite_index = spr_sans_standing_left; 
		}],
		[cutscene_wait_dialog_end],
		...
		[cutscene_wait, 1],
		[cutscene_execute, function () { audio_sound_gain(snd_park, 0, 2000); }],
		[effect_fade, 1.5, 0.5, 1.5, c_black],
		[cutscene_wait, 2],
		[cutscene_execute, function () {
			instance_destroy(sans);
		}],
	...
	[
		...
		[cutscene_wait_by_dialog, 1],
		[cutscene_object_set_sprite, cross, spr_cross_angry],
		[cutscene_wait_dialog_end],
		[cutscene_wait, 1],
		[cutscene_object_set_sprite, ink_sans, spr_ink_sans_left_regrets1],
		[cutscene_wait, 1],
		[cutscene_object_set_sprite, ink_sans, spr_ink_sans_down_empty_eyes],
		[cutscene_wait_dialog_end],
		[cutscene_wait, 0.5],
		...
		[cutscene_object_set_sprite, cross, spr_cross_left_closed_eyes],
		[cutscene_wait_dialog_end],
		[effect_fade, 1, 0.5, 1, c_black],
		[cutscene_wait, 1.5],
		// Cross alone
		[cutscene_execute, function () {
			instance_destroy(ink_sans);
		}],
		[cutscene_object_set_sprite, cross, spr_cross_left_lying],
		[cutscene_wait, 2],
		[cutscene_object_set_sprite, cross, spr_cross_left_gets_up],
		[cutscene_wait, 1.5],
		[cutscene_object_set_sprite, cross, spr_cross_left_turns_around],
	...
	[
		...
		[cutscene_object_set_sprite, cross, spr_cross_in_strings],
		[cutscene_wait, 1],
		[effect_blackout_end],
		[cutscene_execute, function () {
			var i = 0;
		...
		[cutscene_object_set_sprite, error_sans, spr_error_sans_right_strings_up],
		[cutscene_execute, function () {
			var i = 0;
			repeat(2) {
		...
		[cutscene_object_set_sprite, error_sans, spr_error_sans_right_hand],
		[cutscene_execute, function () {
			var i = 0;
			repeat(2) {
		...
		[cutscene_object_set_sprite, cross, spr_cross_in_strings_closed_eyes],
		[cutscene_wait, 1],
		[cutscene_execute, function () {
			var i = 0;
			repeat(2) {
		...
		[cutscene_wait, 0.1],
		[cutscene_object_set_sprite, cross, spr_cross_in_strings],
		[cutscene_object_set_sprite, error_sans, spr_error_sans_dodge_jump_back],
		[cutscene_wait, 0.1],
		[cutscene_execute, function () {
			instance_destroy(soul_cross);
		}],
		[cutscene_object_set_sprite, ink_sans, spr_ink_sans_attack_flying_hit],
	...
	[
		...
		[cutscene_wait, 7],
		[cutscene_object_set_sprite, xchara, spr_xchara_stand_up_on_knees],
		[cutscene_wait, 1.5],
		[cutscene_object_set_sprite, xchara, spr_xchara_on_knees_looking_hands],
		[cutscene_wait, 0.5],
		[cutscene_dialog_async, episode + "Dialog21"],
		[cutscene_wait_by_dialog, 1],
		[cutscene_object_set_sprite, xchara, spr_xchara_on_knees_transform_cross_1],
		[cutscene_wait_by_dialog, 2],
		[cutscene_object_set_sprite, ink_sans, spr_ink_sans_lying_wounded_head_up],
		[cutscene_object_set_sprite, xchara, spr_xchara_on_knees_transform_back],
		[cutscene_wait_dialog_end],
		[cutscene_object_set_sprite, xchara, spr_xchara_on_knees_turns_forward],
		[cutscene_wait, 1.2],
		[cutscene_object_set_sprite, xchara, spr_xchara_on_knees_teleporting],
		[audio_play_sound_once, snd_teleport],
		[cutscene_wait, 2],
		[cutscene_object_set_sprite, ink_sans, spr_ink_sans_lying_wounded],
		[cutscene_dialog, episode + "Dialog22"],
		[cutscene_execute, function() {
			if (ink_has_gone) {
				effect_fade(2, 0, 0, c_white);
			} else {
				effect_fade(2, 0, 2, c_white);
			}
		}],
		[cutscene_wait, 2],
		...
		[cutscene_wait_by_dialog, 1],
		[cutscene_object_set_sprite, ink_sans, spr_ink_sans_down_looking_left_down],
		[cutscene_wait_dialog_end],
		[cutscene_wait, 1],
		[cutscene_object_set_sprite, sans, spr_sans_sitting1],
	...
	[
		// Sans selected "Go" (Index: 9)
		[cutscene_wait, 1],
		[cutscene_object_set_sprite, sans, spr_sans_sitting2],
		[cutscene_dialog_async, episode + "Dialog24_Line1"],
		[cutscene_wait_by_dialog, 1],
		[cutscene_object_set_sprite, ink_sans, spr_ink_sans_left_down_looking_left_joyful],
		[cutscene_wait, 0.5],
		[cutscene_object_set_sprite, sans, spr_sans_sitting6],
		[cutscene_wait_by_dialog, 3],
		[cutscene_object_set_sprite, ink_sans, spr_ink_sans_left_down_looking_left],
		[cutscene_wait_by_dialog, 4],
		[cutscene_object_set_sprite, sans, spr_sans_sitting2],
		[cutscene_wait_by_dialog, 5],
		[cutscene_object_set_sprite, sans, spr_sans_left_down],
		[cutscene_object_set_sprite, ink_sans, spr_ink_sans_left_down_looking_down_calm],
		[cutscene_wait_by_dialog, 6],
		[cutscene_object_set_sprite, ink_sans, spr_ink_sans_left_down_getting_broomie],
		[cutscene_wait_by_dialog, 7],
		[cutscene_wait, 0.5],
		[cutscene_object_set_sprite, sans, spr_sans_down_looking_left],
		[cutscene_wait_dialog_end],
		[cutscene_object_set_sprite, ink_sans, spr_ink_sans_left_down_drawing_on_ground],
		[cutscene_wait, 0.5],
		[cutscene_object_set_sprite, sans, spr_sans_down_looking_right_down],
		[audio_play_sound_once, snd_grab],
		[cutscene_wait, 0.5],
		[cutscene_object_set_sprite, ink_sans, spr_ink_sans_left_down_teleporting],
		[cutscene_wait, 1.5],
		[audio_play_sound_once, snd_wing],
		[cutscene_wait, 1],
		[cutscene_execute, function () {
			papyrus = instance_create_depth(obj_camera.x - 20, 186, fight_depth.player, obj_character_papyrus, { sprite_index: spr_papyrus_picnic_walking_right_plaid });
		}],
		[cutscene_object_move_to, papyrus, obj_camera.x + 90, 186, 2],
		[cutscene_object_set_sprite, papyrus, spr_papyrus_picnic_stopped_right_plaid],
		[cutscene_wait, 0.5],
		[cutscene_dialog, episode + "Dialog27"],
		[cutscene_wait, 2],
		[cutscene_object_set_sprite, sans, spr_sans_down_left_closed_eyes],
		[cutscene_wait, 0.5],
		[cutscene_dialog, episode + "Dialog28"],
		[cutscene_object_set_sprite, sans, spr_sans_walking_left_closed_eyes],
		[cutscene_object_set_speed, sans, 2, 180],
		[cutscene_wait, 1],
		[cutscene_object_set_sprite, papyrus, spr_papyrus_picnic_walking_left_plaid],
	...
	[	
		...
		[cutscene_wait, 1],
		[cutscene_object_set_sprite, sans, spr_sans_sitting_looking_up],
