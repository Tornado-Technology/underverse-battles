...
/// @param {Real} _power
/// @param {Real} type
function fell_sans_attack0(player, _power, type = irandom(5)) {
...
/// @param {Real} _power
/// @param {Real} type
function fell_sans_attack1(player, _power, type = irandom(2)) {
...
/// @param {Real} _power
/// @param {Real} type
function fell_sans_attack2(player, _power, type = irandom(1)) {
