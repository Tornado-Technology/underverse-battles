...
function create_aiming_gasterblaster(gaster_blaster, target, fly_time = 1/6, charge_time = 1, flyout_time = 15/60, destroy_time = 1/6, storage_index = 0, send_data = fight_network_mode) {
	var x_gb, y_gb;
	var gb_size = 60;
	...
	if (send_data) send_battle_object_gasterblaster(x_gb, y_gb, gaster_blaster, target.x, target.y, 0, fly_time, charge_time, flyout_time, destroy_time, storage_index);
