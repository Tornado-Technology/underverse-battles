...
/// @param {Real} _power
/// @param {Real} type
function char_sans_attack_0(player, _power, type = fight_random_integer(0, 5)) {
...
/// @param {Real} _power
/// @param {Real} type
function char_sans_attack_1(player, _power, type = fight_random_integer(0, 2)) {
...
/// @param {Real} _power
/// @param {Real} type
function char_sans_attack_2(player, _power, type = fight_random_integer(0, 1)) {
...
/// @param {Real} _power
/// @param {Real} type
function char_saness_attack_1(player, _power, type = fight_random_integer(0, 2)) {
