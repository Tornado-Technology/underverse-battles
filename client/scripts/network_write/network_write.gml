...
///@arg data
///@arg *socket
// most of the time you just want to send the data to CLIENT.socket
function network_write(data, sock = network_client.sock) {
	//console_log("Encoding data: %", data)
...
///@arg data
///@arg *socket
function send(data, sock = network_client.socket) {
