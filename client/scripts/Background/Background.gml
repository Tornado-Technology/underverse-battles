...
Background(spr_background_underverse_forest_park, _background.forest_park, "Backgrounds.UnderverseForest", "Sayki", universe.underverse);
Background(spr_background_underverse_forest_winter, _background.winter_forest_park, "Backgrounds.WinterForestPark", "Sayki", universe.underverse, obj_background_underverse_forest_winter);
Background(spr_background_underfell_snowdin, _background.underfell_snowdin, "Backgrounds.UnderfellSnowdin", "Sayki", universe.underfell, obj_background_underfell_snowdin);
...
Background(spr_background_determination_machine, _background.determination_machine, "Backgrounds.DeterminationMachine", "Sayki", universe.undertale);
